  ...
  return (
    <div className="project-card">
      <Box mb='50px' border="1px solid rgb(66,153,225)" borderRadius="10px" p="10px" mt="20px" _hover={{ boxShadow: "rgb(57, 142, 211) 0px 4px 16px, rgb(45, 140, 218) 0px 8px 16px;" }}>
        ...
        {/* <Text>Softwin Systems Pvt. Ltd. Mohali</Text> */}
        <Text>{data?.exp}</Text>
        <Text>{data?.desc}</Text>
        <Text style={{ fontWeight: "800", fontSize: "20px" }}>Tech Stacks</Text>
        <Text>HTML | CSS | JAVASCRIPT</Text>
        <Text>REACTJS | NEXTJS</Text>
        <Text>NODEJS | EXPRESSJS | REDUX</Text>
        <Text>MONGODB | MYSQL</Text>
        <Text>SCSS | TAILWIND CSS | AWS</Text>
